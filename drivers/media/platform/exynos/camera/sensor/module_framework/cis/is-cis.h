...
struct sensor_cis_info {
	...
	u32 mipi_mode_count;
	const struct sensor_regs filp_mode[CAM_FLIP_MODE_MAX];
...
int sensor_cis_set_totalgain(struct v4l2_subdev *subdev,
	struct ae_param *target_exposure, struct ae_param *again, struct ae_param *dgain);
...
int sensor_cis_seamless_ctl_before_stream(struct v4l2_subdev *subdev,
	enum is_rta_sensor_mode seamless_mode, u32 value);
