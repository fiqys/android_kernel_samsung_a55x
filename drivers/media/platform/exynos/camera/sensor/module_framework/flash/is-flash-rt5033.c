...
static int flash_rt5033_i2c_probe_i2c(struct i2c_client *client,
...
static int __init flash_rt5033_platform_probe_i2c(struct platform_device *pdev)
{
	int ret = 0;
	struct device *dev;
...
static struct i2c_driver sensor_flash_rt5033_i2c_driver = {
	.probe	= flash_rt5033_i2c_probe_i2c,
	.driver = {
...
static int __init sensor_flash_rt5033_i2c_init_i2c(void)
{
	int ret;
...
late_initcall_sync(sensor_flash_rt5033_i2c_init_i2c);
...
static int __init sensor_flash_rt5033_platform_init_i2c(void)
{
	int ret;

	ret = platform_driver_probe(&sensor_flash_rt5033_platform_driver,
				flash_rt5033_platform_probe_i2c);
	if (ret)
...
late_initcall_sync(sensor_flash_rt5033_platform_init_i2c);
