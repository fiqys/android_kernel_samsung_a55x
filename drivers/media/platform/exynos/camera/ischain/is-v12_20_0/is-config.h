...
#define SUPPORT_DJAG_PRE_FILTER 1
...
#define CHECK_HF_SBWC_DISABLE(exynos_soc_info)	\
...
/* CSIS DEBUG OPTIONS */
#define CONFIG_PANIC_ON_COTF_ERR 0
#define CONFIG_PANIC_ON_CSIS_OVERFLOW 0

/* IOMMU DEBUG OPTIONS */
#define CONFIG_IOMMU_PERF_MEASURE 1
