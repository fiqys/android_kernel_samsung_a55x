...
static struct task_struct *s2mf301_preflash_thread = NULL;

static int s2mf301_trigger_pre_flash(void *data) {

	s2mf301_fled_set_curr(1, CAM_FLASH_MODE_PREFLASH);
	s2mf301_fled_set_mode_ctrl(1, CAM_FLASH_MODE_PREFLASH);
...
int is_vendor_set_torch(struct camera2_shot *shot)
{
