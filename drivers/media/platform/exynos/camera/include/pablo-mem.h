...
struct is_sub_dma_buf {
	...
	const struct pablo_dma_buf_ops		*dbuf_ops;
	const struct pablo_dmabuf_container_ops	*dbuf_con_ops;
};

struct is_sub_buf {
	u32				ldr_vid;
	struct is_sub_dma_buf		leader;
...
struct pablo_dmabuf_container_ops {
