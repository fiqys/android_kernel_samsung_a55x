...
#define V4L2_CID_DEV_INFO_BASE            (V4L2_CTRL_CLASS_CAMERA | 0x5000)
...
#define V4L2_CID_IS_OBTE_CONFIG_SENSOR		(V4L2_CID_FIMC_IS_BASE + 101)
...
#define V4L2_CID_IS_NOTIFY_HAL_INIT		(V4L2_CID_FIMC_IS_BASE + 673)
...
#define V4L2_CID_IS_REMOSAIC_CROP_ZOOM_RATIO     (V4L2_CID_FIMC_IS_BASE + 905)
...
#define V4L2_CID_IS_CAMPOOL_HEAP_SIZE			(V4L2_CID_FIMC_IS_BASE + 0xD00)
...
#define V4L2_CID_SENSOR_SET_STREAM_ON_IN_RC_MODE	(V4L2_CID_SENSOR_BASE + 29)
...
#define V4L2_CID_SENSOR_SET_REMOSAIC_CROP_SHIFT_INFO        (V4L2_CID_SENSOR_BASE + 149)
...
#define V4L2_CID_FLASH_SET_TORCH_PRE_CONFIG             (V4L2_CID_SENSOR_BASE + 307)
#define V4L2_CID_FLASH_GET_DELAYED_PREFLASH_TIME        (V4L2_CID_SENSOR_BASE + 308)
...
#define V4L2_CID_DEV_INFO_GET_FACTORY_SUPPORTED_ID	(V4L2_CID_DEV_INFO_BASE + 1)
#define V4L2_CID_DEV_INFO_GET_ROM_DATA_BY_POSITION	(V4L2_CID_DEV_INFO_BASE + 2)
#define V4L2_CID_DEV_INFO_SET_EFS_DATA			(V4L2_CID_DEV_INFO_BASE + 3)
#define V4L2_CID_DEV_INFO_GET_SENSOR_ID			(V4L2_CID_DEV_INFO_BASE + 4)
#define V4L2_CID_DEV_INFO_GET_AWB_DATA_ADDR		(V4L2_CID_DEV_INFO_BASE + 5)
#define V4L2_CID_DEV_INFO_PERFORM_CAL_RELOAD	(V4L2_CID_DEV_INFO_BASE + 6)
#define V4L2_CID_DEV_INFO_GET_OIS_HALL_DATA		(V4L2_CID_DEV_INFO_BASE + 7)
#define V4L2_CID_DEV_INFO_GET_BPC_OTP			(V4L2_CID_DEV_INFO_BASE + 8)
#define V4L2_CID_DEV_INFO_GET_MODULE_INFO		(V4L2_CID_DEV_INFO_BASE + 9)
#define V4L2_CID_DEV_INFO_GET_SEC2LSI_BUFF		(V4L2_CID_DEV_INFO_BASE + 10)
#define V4L2_CID_DEV_INFO_SET_SEC2LSI_BUFF		(V4L2_CID_DEV_INFO_BASE + 11)
#define V4L2_CID_DEV_INFO_SET_MIPI_PHY			(V4L2_CID_DEV_INFO_BASE + 12)
#define V4L2_CID_DEV_INFO_GET_MIPI_PHY			(V4L2_CID_DEV_INFO_BASE + 13)
#define V4L2_CID_DEV_INFO_GET_CROP_SHIFT_DATA		(V4L2_CID_DEV_INFO_BASE + 14)
...
#define V4L2_PIX_FMT_Y14P     v4l2_fourcc('Y', '1', '4', 'P') /* 14 Greyscale, packed */
...
#endif
#ifndef V4L2_PIX_FMT_NV16M_SBWCL_64_10B
#define V4L2_PIX_FMT_NV16M_SBWCL_64_10B v4l2_fourcc('M', '6', 'L', '7')
#endif
/* for SBWC v2.8 */
...
#endif
#ifndef SBWCL_64_STRIDE_FR
#define SBWCL_64_STRIDE_FR(w) (64 * (((w) + 31) / 32))
#endif
#ifndef SBWCL_64_Y_SIZE_FR
#define SBWCL_64_Y_SIZE_FR(w, h) (SBWCL_64_STRIDE_FR(w) * (((h) + 3) / 4))
#endif
#ifndef SBWCL_64_CBCR_SIZE_FR
#define SBWCL_64_CBCR_SIZE_FR(w, h) (SBWCL_64_STRIDE_FR(w) * ((((h) / 2) + 3) / 4))
#endif
