...
static unsigned int vts_sfr_offset[] = {
    ...
    0x0208, 0x020c, 0x0300, 0x0304, 0x0308,
    0x030c, 0x0310, 0x0314, 0x0318, 0x0320,
    0x0324, 0x0328, 0x032c, 0x0330, 0x0334,
    0x0338, 0x0408, 0x0420, 0x0424, 0x0428,
    0x0430, 0x0434, 0x0600, 0x0700, 0x0704,
    0x0800, 0x0804, 0x0808, 0x080c, 0x0818,
    0x081c, 0x0940, 0x0944, 0x1000, 0x1010,
    0x1014, 0x1018, 0x1800,
};
...
static unsigned int vts_dmic_ahb0_offset[] = {
    0x0000, 0x0004, 0x0008, 0x0010, 0x0014,
    0x0018, 0x0020, 0x0024, 0x0030, 0x0034,
    0x0038, 0x0040, 0x0044,
};

#define VTS_GPIO_BASE		   (0x11780000)
static unsigned int vts_gpio_offset[] = {
    0x0000, 0x0004, 0x0008, 0x000C, 0x0010,
    0x0014, 0x0700, 0x0800, 0x0900, 0x0A00,
    0x0B14,
};
#endif
