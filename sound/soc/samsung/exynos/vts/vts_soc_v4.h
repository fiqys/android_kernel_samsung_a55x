...
static unsigned int vts_sfr_offset[] = {
    0x0000, 0x0004, 0x0008, 0x000c, 0x0010,
    0x0100, 0x0104, 0x0108, 0x0200, 0x0204,
    0x0210, 0x0214, 0x0220, 0x0224, 0x0228,
    0x022c, 0x0230, 0x0234, 0x0300, 0x0304,
    0x0308, 0x030c, 0x0310, 0x0314, 0x0318,
    0x031c, 0x0320, 0x0324, 0x0334, 0x0338,
    0x0430, 0x0434, 0x0500, 0x0504, 0x0508,
    0x0520, 0x0524, 0x0528, 0x0530, 0x0534,
    0x0538, 0x053c, 0x0540, 0x0558, 0x0600,
    0x0604, 0x0608, 0x0620, 0x0624, 0x0628,
    0x0644, 0x0648, 0x0650, 0x0654, 0x0700,
    0x0800, 0x0804, 0x0808, 0x080c, 0x0810,
    0x0814, 0x0818, 0x081c, 0x0820, 0x0828,
    0x0840, 0x0920, 0x0924, 0x0928, 0x092c,
    0x0930, 0x0940, 0x0944, 0x0948, 0x1000,
    0x100c, 0x1040, 0x1044, 0x1100, 0x1800,
};

static unsigned int vts_dmic_if0_offset[] = {
    0x0000, 0x0004, 0x0008, 0x0010, 0x0014,
};

static unsigned int vts_dmic_if1_offset[] = {
    0x0000, 0x0004, 0x0008, 0x0010, 0x0014,
};

static unsigned int vts_slif_offset[] = {
    0x0030, 0x0040, 0x0044, 0x0048, 0x004C,
    0x0100, 0x0104, 0x0108, 0x010C, 0x0110,
    0x0114, 0x0118, 0x011C, 0x0120, 0x0124,
    0x0128, 0x012C, 0x0130, 0x0134, 0x0138,
    0x0150, 0x0154, 0x0200, 0x0204, 0x0208,
    0x020C, 0x0210, 0x0214, 0x0218, 0x021C,
    0x0220, 0x0224, 0x0228, 0x022C, 0x0230,
    0x0234, 0x0238, 0x023C, 0x0300, 0x0304,
    0x0308, 0x030C, 0x0310, 0x0314, 0x0318,
    0x0400, 0x0404, 0x0408, 0x040C, 0x0410,
    0x0414, 0x0418,
};

#define VTS_GPIO_BASE		   (0x13020000)
static unsigned int vts_gpio_offset[] = {
    0x0000, 0x0004, 0x0008, 0x000C, 0x0010,
    0x0014, 0x0700, 0x0800, 0x0804, 0x0900,
    0x0A00, 0x0B14,
};
#endif
