...
#if IS_ENABLED(CONFIG_SND_SOC_CS35L45) || IS_ENABLED(CONFIG_SND_SOC_SAMSUNG_EXYNOS_SMARTPA_AW882XX)
...
#if IS_ENABLED(CONFIG_SND_SOC_SAMSUNG_EXYNOS_SMARTPA_AW882XX)
